...
import {BaseDexUniformVaultV2} from "../forUpgrade/BaseDexUniformVaultV2.sol";
 ...
 */
abstract contract BaseDexVaultV2 is BaseDexUniformVaultV2, IERC721Receiver {
    ...
    function __BaseDexVault_updateStorage(
