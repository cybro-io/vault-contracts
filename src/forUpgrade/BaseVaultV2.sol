 ...
 */
abstract contract BaseVaultV2 is ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, IVault {
    ...
    function __BaseVault_updateStorage(address admin, address manager) internal onlyInitializing {
