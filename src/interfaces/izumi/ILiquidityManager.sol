...
interface ILiquidityManager is IBase {
    /**
    ...
    function mint(MintParam calldata mintParam)
        external
        payable
        returns (uint256 lid, uint128 liquidity, uint256 amountX, uint256 amountY);
    ...
    function addLiquidity(AddLiquidityParam calldata addLiquidityParam)
        external
        payable
        returns (uint128 liquidityDelta, uint256 amountX, uint256 amountY);
    ...
    function decLiquidity(uint256 lid, uint128 liquidDelta, uint256 amountXMin, uint256 amountYMin, uint256 deadline)
        external
        returns (uint256 amountX, uint256 amountY);

    function liquidities(uint256 lid)
        external
        view
        returns (
            int24 leftPt,
    ...
    function collect(address recipient, uint256 lid, uint128 amountXLim, uint128 amountYLim)
        external
        payable
        returns (uint256 amountX, uint256 amountY);
}
